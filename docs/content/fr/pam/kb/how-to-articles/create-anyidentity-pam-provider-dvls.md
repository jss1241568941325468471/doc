...
Les modèles guident {{ fr.DVLS }} dans le mappage des paramètres et des sorties des scripts d'action aux propriétés internes de {{ fr.DPAM }}, facilitant ainsi l'entrée et l'échange d'informations. Les modèles permettent aux utilisateurs de remplir les propriétés d'un fournisseur d'identité pour créer un fournisseur.
